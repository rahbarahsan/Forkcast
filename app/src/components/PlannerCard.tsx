...
interface PlannerCardProps {
  ...
  endDate: string | Date;
  recipes: { id: string; title: string; image?: string }[];
    ...
    >
      ...
      >
        {recipes.map((r) => {
          ...
          const loading = loadingMap[r.id] ?? isRemote;
      ...
      <ConfirmDialog
        ...
        message={`Delete plan from ${parseDate(startDate).toDateString()} to ${parseDate(endDate).toDateString()}?`}
